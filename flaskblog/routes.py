...
from flask import render_template as render, flash, redirect, url_for, request, abort
...
# @app.route("/post/<post_id>") # works just fine
...
def send_reset_email(user):
    ...
    # _external argument is needed here to show the absolute URL
    msg.body = f'''
...
def reset_request():
    ...
    return render('reset_request.html', title='Reset Password', form=form)
